            ...
            <div class="main">
                <div class="clear">
                    ...
                    <p class="foot_links clear">
                        <a href="<?php echo Yii::app()->controller->createUrl("article/list",array('p'=>"novice","cat"=>"question")); ?>">常见问题</a>
                        <i class="pipe">&nbsp;</i>
                        <a href="<?php echo Yii::app()->controller->createUrl("article/list", array("p" => "company", "cat" => "site")); ?>">平台公告</a>
                        <i class="pipe">&nbsp;</i>
                        <a href="<?php echo Yii::app()->controller->createUrl("article/list",array("p"=>"safe","cat"=>"assets")); ?>">资金保障</a>
                        <i class="pipe">&nbsp;</i>
                        <a href="<?php echo Yii::app()->controller->createUrl("article/list",array("p"=>"about","cat"=>"team")); ?>">团队成员</a>
                        <i class="pipe">&nbsp;</i>
