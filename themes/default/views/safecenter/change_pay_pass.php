    ...
    <body>
        ...
        <?php $form = $this -> beginWidget('CActiveForm',array(
            ...
            <table>
                <tr>
			     <td>原支付密码</td>
				 <td><?php echo $form -> passwordField($user_model,'pay_pass',array('style'=>'width:200px;padding:2px 10px;height:20px;border:1px solid #cfcfcf;','placeholder'=>'请输入原支付密码')); ?></td>
			   </tr>
			   	<tr>
			     <td>新支付密码</td>
				 <td><?php echo $form -> passwordField($user_model,'new_pass',array('style'=>'width:200px;padding:2px 10px;height:20px;border:1px solid #cfcfcf;','placeholder'=>'请输入新的支付密码')); ?></td>
			   </tr>
			   <tr>
			     <td>确认新支付密码</td>
				  <td><?php echo $form -> passwordField($user_model,'re_new_pass',array('style'=>'width:200px;padding:2px 10px;height:20px;border:1px solid #cfcfcf;','placeholder'=>'请输入新的支付密码')); ?></td>
			   </tr>                
                <tr>
