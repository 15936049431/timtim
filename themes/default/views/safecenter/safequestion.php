...
<div class="tc_con">
    <table>
        <tr>
            <td>安全保护问题一</td>
            <td>
                <?php echo $form -> dropDownList($safequestion_model,'name_one',$item_arr,array('class'=>'tc_select')); ?>
            </td>
        </tr>
        <tr>
            <td>问题答案一</td>
        ...
        <tr>
            <td>安全保护问题二</td>
            <td>
                <?php echo $form -> dropDownList($safequestion_model,'name_two',$item_arr,array('class'=>'tc_select')); ?>
            </td>
        </tr>
        <tr>
            <td>问题答案二</td>
        ...
        <tr>
            <td>安全保护问题三</td>
            <td>
                <?php echo $form -> dropDownList($safequestion_model,'name_three',$item_arr,array('class'=>'tc_select')); ?>
            </td>
        </tr>
        <tr>
            <td>问题答案三</td>
	    ...
	    <td></td>
            <td>
                <ul>
                    ...
                    <li><button id="tc_in2" type="submit" value="保存">保存</button></li>
                </ul>
            </td>
        </tr>
    </table>
