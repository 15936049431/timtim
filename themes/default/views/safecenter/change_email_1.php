    ...
    <body>
        ...
        <?php $form = $this -> beginWidget('CActiveForm',array(
            ...
            <table>
                <tr>
			     <td>原邮箱：</td>
				 <td><?php echo $user_info -> user_email; ?><input type="hidden" id="user_email" value="<?php echo $user_info->user_email; ?>"/></td>
			   </tr>
			   	<tr>
			     <td>验证码：</td>
...
$("#sendcode").click(function(){
	...
	if(_email!="" && _email!=null){
		$.post('<?php echo Yii::app()->controller->createUrl("safecenter/Sendemail",array("type"=>"safecenter_change_email_1")); ?>&email='+_email,{},function(data){
			var obj = eval('('+data+')');
            if(obj.status == 1){
	            pointererror("发送成功",1);
				window_sec = 60;
