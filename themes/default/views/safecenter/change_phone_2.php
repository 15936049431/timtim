    ...
    <body>
        ...
        <?php $form = $this -> beginWidget('CActiveForm',array(
            ...
            <table>
                <tr>
			     <td>手机：</td>
				 <td><?php echo $form -> textField($user_model,'user_phone',array('class'=>'tc_text1')); ?></td>
			   </tr>
			   	<tr>
			     <td>验证码：</td>
...
function djs(){
	...
	$("#sendcode").click(function(){
		sendmsg('Userprofile_user_phone','<?php echo Yii::app()->controller->createUrl("safecenter/Sendsms",array("type"=>"safecenter_change_phone_2")); ?>');
		window_sec = 60;
        djs();
	});
</script>
