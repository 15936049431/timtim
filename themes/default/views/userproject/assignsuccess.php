      ...
      <div id="zj_gaikuang1">
       <div class="slideTxtBox">
			<div class="hd" id="zj_nav">
				...
				<li class="on" onclick="window.location.href='<?php echo Yii::app()->controller->createUrl("userproject/assignsuccess"); ?>'">成功转让的债权</li>
                    ...
                    <div class="cz_info">
                         <table>
							...
							<tr>
								...
								<td><?php if($v->debt_status==0){echo "转让中";}elseif($v->debt_status==1){echo "转让成功";}else{echo "已撤销";} ?></td>
								<td><?php if($v->debt_status==0){ ?><a href="">撤销</a><?php } ?></td>
							</tr>
							<?php } ?>
						 </table>
					</div>
