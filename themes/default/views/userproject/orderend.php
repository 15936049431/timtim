...
?>
				<div class="user_money_main">
                        <dl class="user_money_tab clear">
                            ...
                            <dd class="sel"><a href="<?php echo Yii::app()->controller->createUrl("userproject/orderend"); ?>">已收明细</a></dd>
                            <dd><a href="<?php echo Yii::app()->controller->createUrl("userproject/orderwait"); ?>">未收明细</a></dd>
                        </dl>
                       <?php $form = $this->beginWidget('CActiveForm',array(
							'method'=>'GET',
							'action'=>Yii::app()->controller->createUrl('userproject/orderend'),
							'htmlOptions'=>array(
								'name'=>'form_search',
								'class'=>'user_search',
							),
