...
class ProjectOrder extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('p_id, p_user_id, p_status, p_project_id, p_money, p_realmoney, p_repayaccount, p_interest,p_waitrepay, p_waitinterest, p_addtime, p_addip', 'required','on'=>'order_end'),
			...
			array('pay_pass, p_money','required','on'=>'order_one'),
