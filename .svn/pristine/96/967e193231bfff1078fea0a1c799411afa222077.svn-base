...
/**
 * This is the model class for table "{{project_pic}}".
 *
 * The followings are the available columns in table '{{project_pic}}':
 * @property string $p_id
 * @property string $p_project_id
 * @property string $p_user_id
 * @property string $p_pic
 * @property string $p_src
...
class ProjectPic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('p_id, p_project_id, p_user_id, p_pic, p_src, p_addtime, p_addip', 'required'),
			array('p_id, p_project_id, p_user_id', 'length', 'max'=>18),
			array('p_pic, p_src', 'length', 'max'=>255),
			array('p_addtime, p_addip', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('p_id, p_project_id, p_user_id, p_pic, p_src, p_addtime, p_addip', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('p_src',$this->p_src,true);
