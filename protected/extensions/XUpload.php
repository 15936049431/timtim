 ...
 * 文件上传
 * 
 * @author        jy_team <team@7pointer.cn>
 * @link          http://www.7pointer.con
 * @package       7pointer.Tools
 * @license       http://www.7pointer.com
 * @version       v2.1.0
 */
class XUpload {
     ...
     * @return unknown
     */
    private static function _saveRule( $params = array( 'rule'=>'default', 'format'=>'Ymd' ) ) {
        $path = '';
        switch ( $params['rule'] ) {
        case 'custom':
            $path .= $params['string'] . '/';
    ...
    static public function upload( $fileFields, $input = false) {
        $default =  array( 'thumb'=>false, 'thumbSize' => array( 400, 400 ), 'allowExts' => 'jpg,gif,png,jpeg', 'maxSize' => 3292200,'saveRule'=>array('rule'=>'default', 'format'=>'Ymd') );
