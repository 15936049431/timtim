...
class UsercenterController extends WController {
    ...
    public function actionrecharge(){
        ...
        if (isset($_POST['AssetsRecharge'])) {
			if(($_POST['AssetsRecharge']['r_recharge_type']=="lianlianauth_pay" || $_POST['AssetsRecharge']['r_recharge_type']=="yinlianauth_pay") && empty($_POST['bankCard'])){
                ...
                if ($_POST['type'] == "online" || ($_POST['type'] == "overline" && !empty($_POST['AssetsRecharge']['r_BillNo']))) {
					...
					$recharge_model->bankCard =	empty($_POST['bankCard']) ? "" : $_POST['bankCard'];
    ...
    public function actiondouble_return(){
    	$success = Yii::app()->user->getFlash("success");
    	$this->render("double_return",array(
    			"success"=>$success,
    	));
    }
