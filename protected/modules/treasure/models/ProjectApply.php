...
class ProjectApply extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('p_userid, p_name, p_money, p_time_limit, p_phone, p_realname, p_province, p_city, p_addtime, p_addip,p_verifyremark,p_verifyuser,p_verifytime,p_status', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'city' => array(self::BELONGS_TO, 'Area', 'p_city'),
			'province' => array(self::BELONGS_TO, 'Area', 'p_province'),
			'verify_user' => array(self::BELONGS_TO, 'Manager', 'p_verifyuser'),
		);
	}
