...
class Assets extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, total_money, real_money, frost_money, have_interest, wait_interest, wait_total_money,ourmoney', 'required'),
			...
			array('user_id, total_money, real_money, frost_money, have_interest, wait_interest, wait_total_money,ourmoney', 'safe', 'on'=>'search'),
		);
	}
