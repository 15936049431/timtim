<?php
    $this->page_title = '文章分类中心';
    $this->page_desc = '文章分类中心简介';
?>
...
<table class="table table-advance">
    <thead>
        <tr>
            ...
            <th><?php echo $model->getAttributeLabel('article_cat_name'); ?></th>
            <th><?php echo $model->getAttributeLabel('article_cat_alias'); ?></th>
<th><?php echo $model->getAttributeLabel('article_cat_desc'); ?></th>
...
<th><?php echo $model->getAttributeLabel('add_time'); ?></th>
    ...
    <tbody>
        ...
        <tr>
            <td><input type="checkbox" class="checkdel" value="<?php echo $v->article_cat_id; ?>"></td>
            <td><?php echo $v->nname; ?></td>
            <td><?php echo $v->article_cat_alias; ?></td>
<td><?php echo $v->article_cat_desc; ?></td>
...
<td><?php echo LYCommon::subtime($v->add_time,2); ?></td>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="" href="<?php echo Yii::app()->controller->createUrl($v->cat_type == 2?'pageupdate':'update',array('id'=>$v->article_cat_id)); ?>" data-original-title="编辑"><i class="icon-edit"></i></a>
                    <a class="btn btn-small btn-danger show-tooltip" title="" href="javascript:;" onclick="deldata('<?php echo $v->article_cat_id; ?>')" data-original-title="删除"><i class="icon-trash"></i></a>
                </div>
            </td>
        </tr>
        <?php } ?>
