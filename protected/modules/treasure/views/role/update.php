...
<script type="text/javascript">
    window.onload = function(){
        <?php foreach($haveoperetion_list as $k => $v){ ?>
        var fname = $("#<?php echo sha1($v['child']) ?>").parent().parent().attr('id');
        $("#<?php echo sha1($v['child']) ?>").attr("checked",'true');
        $("#<?php echo sha1($v['child']) ?>").attr("value",'1');
        var count = 0;
