...
<!--                输出错误信息  结束-->
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->textField($model,'name',array('class'=>'input-xlarge','placeholder'=>'请填写角色名称')); ?>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                          <?php echo $form->textArea($model,'description',array('class'=>'span4','rows'=>'5','placeholder'=>'请填写角色描述')); ?>
                      </div>
                   </div>
                   ...
                   <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->textField($model,'defaulturl',array('class'=>'input-xlarge','placeholder'=>'请填写默认登陆URL')); ?>
                        </div>
                    </div>
