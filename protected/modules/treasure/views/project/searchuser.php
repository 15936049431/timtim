...
<table class="table table-advance">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="" href="<?php echo Yii::app()->controller->createUrl('project/adduserproject',array('uid'=>$v->user_id)); ?>" data-original-title="发布借款"><i class="icon-plus"></i></a>
                </div>
            </td>
        </tr>
        <?php } ?>
