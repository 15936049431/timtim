...
<!--            <a class="btn btn-circle show-tooltip" title="" href="#" data-original-title="Export to PDF"><i class="icon-file-text-alt"></i></a>
        ...
        <div class="btn-group">
        	<a class="btn btn-circle show-tooltip" title="" target="_blank" href="<?php echo Yii::app()->controller->createUrl('fail_full_check_list',array('outfile_excel'=>'1')); ?>" data-original-title="导出Exel"><i class="icon-table"></i>
...
<th><?php echo $model->getAttributeLabel('real_name'); ?></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo empty($v->user) ? "" : $v->user->user_name; ?></td>
            <td><?php echo empty($v->user) ? "" : $v->user->real_name; ?></td>
