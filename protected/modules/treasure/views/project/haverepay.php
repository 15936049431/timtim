...
<!-- <a class="btn btn-circle show-tooltip" title="" href="<?php echo Yii::app()->controller->createUrl('project/create'); ?>" data-original-title="添加文章"><i class="icon-plus"></i></a>
        ...
        <div class="btn-group">
        	<a class="btn btn-circle show-tooltip" title="" target="_blank" href="<?php echo Yii::app()->controller->createUrl('haverepay',array('outfile_excel'=>'1')); ?>" data-original-title="导出Exel"><i class="icon-table"></i>
...
<th><?php echo $model->getAttributeLabel('p_repayyestime'); ?></th>
...
<th><?php echo $model->getAttributeLabel('p_interest'); ?></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo LYCommon::subtime($v->p_repayyestime,2); ?></td>
