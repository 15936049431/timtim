...
<!--            <a class="btn btn-circle show-tooltip" title="" href="#" data-original-title="Export to PDF"><i class="icon-file-text-alt"></i></a>
        ...
        <div class="btn-group">
            <a class="btn btn-circle show-tooltip" title="" target="_blank" href="<?php echo Yii::app()->controller->createUrl('full_check_list',array('outfile_excel'=>'1')); ?>" data-original-title="导出Exel"><i class="icon-table"></i>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-small show-tooltip" title="" href="<?php echo Yii::app()->controller->createUrl('full_check_oper',array('id'=>$v->p_id)); ?>" data-original-title="编辑"><i class="icon-edit"></i></a>
                </div>
            </td>
        </tr>
        <?php } ?>
