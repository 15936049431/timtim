...
<table class="table table-advance">
    <thead>
        <tr>
            <th><?php echo $model->getAttributeLabel('award_name'); ?></th>
			<th><?php echo $model->getAttributeLabel('award_alias'); ?></th>
			<th><?php echo $model->getAttributeLabel('award_desc'); ?></th>
			<th><?php echo $model->getAttributeLabel('award_money'); ?></th>
			<th><?php echo $model->getAttributeLabel('award_user'); ?></th>
			<th><?php echo $model->getAttributeLabel('award_all'); ?></th>
