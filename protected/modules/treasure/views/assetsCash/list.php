<?php
    $this->page_title = '提现中心';
    $this->page_desc = '提现中心简介';
...
<div class="clearfix">
    <div class="pull-left" style="padding-left: 1em;">
        <?php $form = $this->beginWidget('CActiveForm',array(
            'action'=>Yii::app()->controller->createUrl('assetsCash/list'),
            'method'=>'GET',
            'htmlOptions'=>array(
                'name'=>'form_search'
            ),
        ...
        <table class="search_table">
			<tr>
				<td>状态：</td>
                <td><?php echo $form->dropDownList($model,'c_status',array('-1'=>'全部',"0"=>"未审","1"=>"通过","2"=>"失败"),array('class'=>'input-xlarge')); ?></td>
				<td>用户名：</td>
...
<div class="box-content">
    <div class="btn-toolbar pull-right">
        <div class="btn-group">
            <!--<a class="btn btn-circle show-tooltip" title="" href="<?php echo Yii::app()->controller->createUrl('create'); ?>" data-original-title="添加提现"><i class="icon-plus"></i></a>
            <a class="btn btn-circle show-tooltip" title="" href="#" data-original-title="Edit selected"><i class="icon-edit"></i></a>
            <a class="btn btn-circle show-tooltip" title="" href="javascript:;" onclick="delmore()" data-original-title="删除选中提现"><i class="icon-trash"></i></a>-->
        </div>
        <div class="btn-group">
...
<!--            <a class="btn btn-circle show-tooltip" title="" href="#" data-original-title="Export to PDF"><i class="icon-file-text-alt"></i></a>
        ...
        <div class="btn-group">
            ...
            <a class="btn btn-circle show-tooltip" title="" href="javascript:;" data-original-title="刷新"><i class="icon-repeat"></i></a>
        </div>
    </div>
...
<th><?php echo $model->getAttributeLabel('c_province'); ?></th>
<th><?php echo $model->getAttributeLabel('c_city'); ?></th>
<th><?php echo $model->getAttributeLabel('c_bank'); ?></th>
<th><?php echo $model->getAttributeLabel('c_cardNum'); ?></th>
<th><?php echo $model->getAttributeLabel('c_status'); ?></th>
<th><?php echo $model->getAttributeLabel('c_money'); ?></th>
<th><?php echo $model->getAttributeLabel('c_realmoney'); ?></th>
<th><?php echo $model->getAttributeLabel('c_fee'); ?></th>
<th><?php echo $model->getAttributeLabel('c_addtime'); ?></th>
    ...
    <tbody>
        ...
        <tr>
  <!--           <td><input type="checkbox" class="checkdel" value="<?php echo $v->c_id; ?>"></td>-->
<td><a href="<?php echo Yii::app()->controller->createUrl('user/update',array('id'=>$v->c_user_id)); ?>" ><?php echo $v->user->user_name; ?></a></td>
<td><?php echo $v->user->real_name; ?></td>
<td><?php echo empty($v->c_city)?"未知":$v->area_c->name; ?></td>
<td><?php echo empty($v->c_province)?"未知":$v->area_p->name; ?></td>
<td><?php echo empty($v->c_bank) ? "未知" : $v->item->i_name; ?></td>
<td><?php echo $v->c_cardNum; ?></td>
<td><?php echo $model->itemAlias('c_status',$v->c_status); ?></td>
<td>￥<?php echo $v->c_money; ?></td>
<td>￥<?php echo $v->c_realmoney; ?></td>
<td>￥<?php echo $v->c_fee; ?></td>
<td><?php echo LYCommon::subtime($v->c_addtime,2); ?></td>
            <td>
                <div class="btn-group">
<!--                    <a class="btn btn-small show-tooltip" title="" href="#" data-original-title="查看"><i class="icon-zoom-in"></i></a>-->
                    <a class="btn btn-small show-tooltip" title="" href="<?php echo Yii::app()->controller->createUrl('update',array('id'=>$v->c_id)); ?>" data-original-title="编辑"><i class="icon-edit"></i></a>
                    <!-- <a class="btn btn-small btn-danger show-tooltip" title="" href="javascript:;" onclick="deldata('<?php echo $v->c_id; ?>')" data-original-title="删除"><i class="icon-trash"></i></a>-->
                </div>
            </td>
        </tr>
        <?php } ?>
