...
<div class="row-fluid">
        ...
        <!--                输出错误信息  开始-->
                        ...
                        <div class="control-group">
                            <label class="control-label required" for="Sms_get_user_contact">选择类型 <span class="required">*</span></label>
                            <div class="controls">
                                <?php echo $form->dropDownList($model,'codecat_id',$codecat_arr); ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->textField($model,'target',array('class'=>'input-xlarge','placeholder'=>'请填写'.$model->getAttributeLabel('target'))); ?>
                                <span class="help-inline"></span>
                            </div>
                        </div>
