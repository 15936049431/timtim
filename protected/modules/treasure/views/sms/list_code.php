...
<table class="table table-advance">
    <thead>
        <tr>
            ...
            <th><?php echo $model->getAttributeLabel('code_id'); ?></th>
            <th><?php echo $model->getAttributeLabel('codecat_name'); ?></th>
            <th><?php echo $model->getAttributeLabel('target'); ?></th>
            ...
            <th><?php echo $model->getAttributeLabel('add_ip'); ?></th>
    ...
    <tbody>
        ...
        <tr>
            <td><input type="checkbox" class="checkdel" value="<?php echo $v->code_id; ?>"></td>
            <td><?php echo $v->code_id; ?></td>
            <td><?php echo $v->codecat->codecat_name; ?></td>
