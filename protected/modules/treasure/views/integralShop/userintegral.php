<?php
    $this->page_title = '用户积分';
    $this->page_desc = '用户积分详情';
?>
<style type="text/css">
...
<th><?php echo $model->getAttributeLabel('i_total_value'); ?></th>
<th><?php echo $model->getAttributeLabel('i_real_value'); ?></th>
<th><?php echo $model->getAttributeLabel('i_used_value'); ?></th>
<th><?php echo $model->getAttributeLabel('i_updatetime'); ?></th>
...
<td><?php echo $v->i_total_value; ?></td>
<td><?php echo $v->i_real_value; ?></td>
<td><?php echo $v->i_used_value; ?></td>
<td><?php echo LYCommon::subtime($v->i_updatetime,2); ?></td>
