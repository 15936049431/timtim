...
<div class="clearfix">
    <div class="pull-left" style="padding-left: 1em;">
		...
		<div class="" style="display: inline-block;">
            <?php echo $form->dropDownList($model,'i_type',$type_list,array('class'=>'input-xlarge')); ?>
        </div>
        <div class="" style="display: inline-block;">
            <?php echo $form->textField($model,'i_name',array('placeholder'=>'请输入商品名称')); ?>
        </div>
        <div class="btn-group">
...
<!--            <a class="btn btn-circle show-tooltip" title="" href="#" data-original-title="Export to PDF"><i class="icon-file-text-alt"></i></a>
        ...
        <div class="btn-group">
        	<a class="btn btn-circle show-tooltip" title="" target="_blank" href="<?php echo Yii::app()->controller->createUrl('list',array('outfile_excel'=>'1',
            		'IntegralShop[i_type]'=>isset($_GET['IntegralShop'])?$_GET['IntegralShop']['i_type']:"",
            		'IntegralShop[i_name]'=>isset($_GET['IntegralShop'])?$_GET['IntegralShop']['i_name']:"")); ?>" data-original-title="导出Exel"><i class="icon-table"></i>
...
<th><?php echo $model->getAttributeLabel('i_type'); ?></th>
<th><?php echo $model->getAttributeLabel('i_price'); ?></th>
<th><?php echo $model->getAttributeLabel('i_num'); ?></th>
<th><?php echo $model->getAttributeLabel('i_selenum'); ?></th>
<th><?php echo $model->getAttributeLabel('i_twice'); ?></th>
...
<td><?php echo $v->i_price; ?></td>
<td><?php echo $v->i_num; ?></td>
<td><?php echo $v->i_selenum; ?></td>
<td><?php echo $model->itemAlias('i_twice',$v->i_twice); ?></td>
<td><?php echo LYCommon::subtime($v->i_addtime,2); ?></td>
