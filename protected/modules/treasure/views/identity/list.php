...
<div class="clearfix">
    <div class="pull-left" style="padding-left: 1em;">
        ...
        <div class="" style="display: inline-block;">
            用户名： <input type="text" name="Identity[user_name]" placeholder='请输入用户名' value="<?php echo !empty($_GET['Identity']['user_name'])?$_GET['Identity']['user_name']:'' ?>">
            真实姓名：<?php echo $form->textField($model,'real_name',array('placeholder'=>'请输入真实姓名')); ?>
            身份证号：<?php echo $form->textField($model,'identity_num',array('placeholder'=>'请输入身份证号')); ?>
        </div>
        <div class="btn-group">
...
<!--            <a class="btn btn-circle show-tooltip" title="" href="#" data-original-title="Export to PDF"><i class="icon-file-text-alt"></i></a>
        ...
        <div class="btn-group">
			<a class="btn btn-circle show-tooltip" title="" target="_blank" href="<?php echo Yii::app()->controller->createUrl('list',array('outfile_excel'=>'1',
        			'Identity[user_name]'=>isset($_GET['Identity'])?$_GET['Identity']['user_name']:"",
