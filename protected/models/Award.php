...
class Award extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, award_name, award_alias, award_content, award_desc, award_check, award_money, award_user, award_all, start_time, end_time, add_time, add_ip', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'award_check' => 'Award Check',
			'award_money' => 'Award Money',
			'award_user' => 'Award User',
			'award_all' => 'Award All',
