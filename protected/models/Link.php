...
class Link extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('link_name, link_pic, link_url, link_type, link_order, add_time, update_time', 'required'),
			array('link_type, link_order, add_time, update_time', 'numerical', 'integerOnly'=>true),
			array('link_name, link_pic, link_url', 'length', 'max'=>64),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('link_id, link_name, link_pic, link_url, link_type, link_order, add_time, update_time', 'safe', 'on'=>'search'),
		);
	}
